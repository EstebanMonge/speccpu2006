...
Saves SPEC CPU 2006 test results to CSV files, Google BigQuery, MySQL or 
PostgreSQL. Test artifacts may also be saved to S3, Google Cloud Storage or 
Azure (API) compatible object storage
